<div class="navbar navbar-custom" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="/statuspage/public"><span>{{ $app_name }}</span></a>
        </div>

        <div class="navbar-collapse collapse" id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/statuspage/public">{{ trans('cachet.home') }}</a></li>
                @if($current_user)
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu arrow">
                        ...
                        <li><a href="/statuspage/public/dashboard">{{ trans('dashboard.dashboard') }}</a></li>
