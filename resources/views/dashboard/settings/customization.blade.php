...
@section('content')
    <div class="content-panel">
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form id="settings-form" name="SettingsForm" class="form-vertical" role="form" action="/statuspage/public/dashboard/settings" method="POST" enctype="multipart/form-data">
